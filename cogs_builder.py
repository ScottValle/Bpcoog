...
def blastresults(br_naam1, br_naam2, br_pos1, tbr_pos2):
    ...
    for zin in twogdeellijst:             
        singles[(zin.split()[br_pos1] + " " + zin.split()[tbr_pos2])] = 0
    return singles.keys()
...
def cogupdate(cogs, twogs, prots):
    ...
    voeftoeaancog(cu_in_lijst_toevoegen)
...
# Dit gebeurt door middel van de functie "voeftoeaancog".
# De functie heeft 3 verschillende parameters nodig (op volgorde):
#    * ncf_cogs      coglijst
#    * ncf_twogs     twoglijst
#    * ncf_prots     protlijst
